...
- [Phase 8](https://github.com/eddiethedean/ontologos/blob/main/docs/internal/roadmap.md#phase-8--expressivity-prerequisites-e1e5) — E1–E5 expressivity tracks complete (with documented waivers)
