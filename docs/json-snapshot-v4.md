...
**Status:** **`FORMAT_VERSION = 4`** on workspace **1.1.1** (`main`). **Published v1.0.0** writers still emit **v3** — see [JSON snapshot v3](json-snapshot-v3.md). Readers on `main` accept v2–v4; writers on `main` emit v4.
