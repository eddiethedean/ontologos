...
RDFS TBox materialization via [`ontologos-rl`](https://docs.rs/ontologos-rl/1.1.2) (`ontologos_rl::rdfs`): transitive `subClassOf` / `subPropertyOf` closure and object-property domain/range inheritance.

> **v0.9.x legacy:** The standalone `ontologos-rdfs` crate was removed in **1.1.2**. Use `ontologos_rl::rdfs::RdfsEngine` — see [v0.9.x → v1.0.0](../migration/v0.9.x-to-v1.0.0.md).
