...
Completion-based **OWL EL taxonomy classification** via `ontologos-el` (v0.8.0).
...
- Explanations for EL inferences are available via `ontologos-explain` and CLI `explain` (v0.8.0).
