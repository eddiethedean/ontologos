...
Copy-paste workflows for Rust and Python. Install pins use **v1.1.2** unless noted.
...
| Goal | Install |
|------|---------|
| All production profiles (EL, RL, RDFS, DL, SWRL) | `pip install ontologos==1.1.2` or `ontologos-* = "1.1.2"` |
