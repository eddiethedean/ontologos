...
| **What blocks the v1.0 tag?** | crates.io/PyPI publish + annotated git tag — engineering gates are green; see [Release checklist](https://github.com/eddiethedean/ontologos/blob/main/docs/project/release-1.0-checklist.md) |
...
| `docs/guides/evaluator-scope.md` | Public summary — what 100% catalog parity does and does not mean |
