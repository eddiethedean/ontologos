...
Use `from_json_with_limits` — format v1 is rejected. Writers emit **v3** on v1.1.0; readers accept v2 and v3.
...
Stable **`--profile dl`** on v1.1.0 uses bounded tableau reasoning. Follow this checklist before serving DL in production:
