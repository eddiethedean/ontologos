...
Use `from_json_with_limits` — format v1 is rejected. Writers emit **v3** on v1.1.2; readers accept v2 and v3.
...
Stable **`--profile dl`** on v1.1.2 uses bounded tableau reasoning. Follow this checklist before serving DL in production:
