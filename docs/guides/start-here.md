...
Source-build from a clone — see [Bindings overview](bindings-overview.md). Rust and Python are on crates.io/PyPI at **v1.1.2**.
...
[Upgrade to latest](../migration/index.md) — **v1.1.2** published on crates.io and PyPI; see [v1.0.x → v1.1.0](../migration/v1.0.x-to-v1.1.0.md) if upgrading from 1.0.
