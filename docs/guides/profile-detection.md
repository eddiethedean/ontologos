...
Detect which OWL 2 profile best fits an ontology using [`ontologos-profile`](https://docs.rs/ontologos-profile/0.6.1).
...
- [Roadmap summary](../project/roadmap-summary.md) — reasoning engines and milestones
