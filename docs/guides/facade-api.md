...
See `ParseLimits` on [docs.rs/ontologos-parser](https://docs.rs/ontologos-parser/1.0.0) for byte/entity/axiom caps.
...
- [docs.rs/ontologos-facade](https://docs.rs/ontologos-facade/1.0.0)
