...
Drop-in patch over **v1.1.3** — bump all `ontologos-*` pins together. See [CHANGELOG](../../CHANGELOG.md).
...
| Tag | Theme |
|-----|-------|
| [v1.1.4](https://github.com/eddiethedean/ontologos/releases/tag/v1.1.4) | Docs migration link fixes |
