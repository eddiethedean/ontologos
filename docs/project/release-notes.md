...
| Version | Theme | Notes |
|---------|-------|-------|
| [v1.1.1](https://github.com/eddiethedean/ontologos/blob/main/.github/release/v1.1.1.md) | Multi-language bindings | Java, .NET, C/C++, shared FFI; Node/WASM over `ontologos-js` |
