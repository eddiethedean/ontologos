...
4. [Release workflow](https://github.com/eddiethedean/ontologos/blob/main/.github/workflows/release.yml) publishes crates.io (12 crates), PyPI wheels, Wasmer `eddiethedean/ontologos`, and npm (`ontologos`, `@ontologos/wasm`) on tag push.
...
| `NPM_TOKEN` | npm `ontologos` + `@ontologos/wasm` |
