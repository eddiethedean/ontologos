...
Transparent wrapper over profile engine errors. See [docs.rs](https://docs.rs/ontologos-facade/1.1.1/ontologos_facade/enum.Error.html).
...
Errors from the core crate: [`Error`](https://docs.rs/ontologos-core/1.1.1/ontologos_core/enum.Error.html).
