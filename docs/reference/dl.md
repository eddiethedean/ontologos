...
OWL 2 DL classification and consistency via [`ontologos-dl`](https://docs.rs/ontologos-dl/1.1.2), routed through [`ontologos-facade`](facade.md).
...
|---------|--------|----------|
| `Dl` | Stable on v1.1.2 | Full DL engine |
