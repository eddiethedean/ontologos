...
In-memory ontology model via [`ontologos-core`](https://docs.rs/ontologos-core/1.1.1).
...
See builder methods on [docs.rs](https://docs.rs/ontologos-core/1.1.1/ontologos_core/struct.OntologyBuilder.html).
