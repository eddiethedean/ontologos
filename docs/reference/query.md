...
Taxonomy navigation and conjunctive queries via [`ontologos-ql`](https://docs.rs/ontologos-ql/1.1.0).
...
| API | Purpose |
|-----|---------|
| [`TaxonomyHierarchy`](https://docs.rs/ontologos-ql/1.1.0/ontologos_ql/struct.TaxonomyHierarchy.html) | Subclass/superclass navigation after EL or DL classification |
| [`answer_query`](https://docs.rs/ontologos-ql/1.1.0/ontologos_ql/fn.answer_query.html) | OWL QL conjunctive query answering |
