...
OWL profile detection via [`ontologos-profile`](https://docs.rs/ontologos-profile/1.0.0).
...
Full API: [docs.rs/ontologos-profile/1.0.0](https://docs.rs/ontologos-profile/1.0.0)
