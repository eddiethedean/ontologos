...
OWL profile detection via [`ontologos-profile`](https://docs.rs/ontologos-profile/1.1.2).
...
Full API: [docs.rs/ontologos-profile/1.1.2](https://docs.rs/ontologos-profile/1.1.2)
