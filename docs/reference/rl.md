...
OWL RL saturation and RDFS materialization via [`ontologos-rl`](https://docs.rs/ontologos-rl/1.1.1).
...
Full API: [docs.rs/ontologos-rl/1.1.1](https://docs.rs/ontologos-rl/1.1.1)
