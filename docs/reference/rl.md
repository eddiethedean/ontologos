...
OWL RL saturation and RDFS materialization via [`ontologos-rl`](https://docs.rs/ontologos-rl/1.1.3).
...
Full API: [docs.rs/ontologos-rl/1.1.3](https://docs.rs/ontologos-rl/1.1.3)
