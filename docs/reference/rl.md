...
OWL RL saturation and RDFS materialization via [`ontologos-rl`](https://docs.rs/ontologos-rl/1.1.4).
...
Full API: [docs.rs/ontologos-rl/1.1.4](https://docs.rs/ontologos-rl/1.1.4)
