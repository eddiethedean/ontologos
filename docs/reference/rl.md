...
OWL RL saturation and RDFS materialization via [`ontologos-rl`](https://docs.rs/ontologos-rl/1.1.2).
...
Full API: [docs.rs/ontologos-rl/1.1.2](https://docs.rs/ontologos-rl/1.1.2)
