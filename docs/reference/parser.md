...
OWL and RDF file loading via [`ontologos-parser`](https://docs.rs/ontologos-parser/1.1.3).

## Overview

| Function | Purpose |
|----------|---------|
| [`load_ontology`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ontology.html) | Load with default `ParseLimits` |
| [`load_ontology_with_limits`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ontology_with_limits.html) | Load with custom limits |
| [`load_ontology_with_limits_and_base`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ontology_with_limits_and_base.html) | Load with sandbox base directory |
| [`load_ontology_in`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ontology_in.html) | Load relative to a base directory |
| [`load_ontology_lenient`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ontology_lenient.html) | Lenient limits (`strict: false`) |
| [`load_ofn_from_str`](https://docs.rs/ontologos-parser/1.1.3/ontologos_parser/fn.load_ofn_from_str.html) | Parse OWL Functional Syntax from a string |
...
- [docs.rs/ontologos-parser](https://docs.rs/ontologos-parser/1.1.3)
