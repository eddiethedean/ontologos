...
**Status:** v0.7.0 on `main` (pending tag) — dependency-first adapters (`ontologos-bridge`), EL completion, and RL/RDFS over reasonable. **Not** full OWL DL / HermiT replacement.
