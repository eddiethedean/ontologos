...
| **Rust** | Add `ontologos-parser`, `ontologos-facade` @ `1.1.3` to `Cargo.toml` |
...
**v1.1.3** on [crates.io](https://crates.io/crates/ontologos-core) and [PyPI](https://pypi.org/project/ontologos/). Install channels: [guide](https://ontologos.readthedocs.io/en/latest/guides/install-channels.html).
