...
| **Rust** | Add `ontologos-parser`, `ontologos-facade` @ `1.1.2` to `Cargo.toml` |
| **CLI** | `cargo install --git https://github.com/eddiethedean/ontologos --tag v1.1.2 ontologos-cli` |
...
**v1.1.2** on [crates.io](https://crates.io/crates/ontologos-core) and [PyPI](https://pypi.org/project/ontologos/). Install channels: [guide](https://ontologos.readthedocs.io/en/latest/guides/install-channels.html).
...
You do **not** need to clone this repo to use OntoLogos from crates.io or PyPI.
