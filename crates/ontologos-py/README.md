...
Python bindings for [OntoLogos](https://github.com/eddiethedean/ontologos) — a Rust-native OWL reasoner for **RDFS**, **OWL RL**, **OWL EL**, **OWL 2 DL**, and **SWRL** on [PyPI](https://pypi.org/project/ontologos/) (**1.1.4** published).
