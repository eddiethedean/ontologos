...
Python bindings for [OntoLogos](https://github.com/eddiethedean/ontologos) — a Rust-native OWL reasoner for **RDFS**, **OWL RL**, **OWL EL**, **OWL 2 DL**, and **SWRL** on [PyPI](https://pypi.org/project/ontologos/) (**1.1.2** published).
...
Load from JSON dict instead of the builder (v2 or v3; writers on workspace 1.1.2 emit v3):
