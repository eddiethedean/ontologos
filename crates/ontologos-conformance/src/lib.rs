...
pub use catalog::{
    ...
    check_axiom_case_bounded, check_logical_entailment, check_user_axiom_case, check_user_wg_case,
    check_wg_case, ensure_concurrent_scan_defaults, entailment_holds_with_budget_opts,
    load_catalog, load_wg_catalog, parity_metrics, profile_for_engine, promoted_axiom_ids_path,
    promoted_wg_ids_path, read_catalog_file, read_promoted_axiom_ids, read_promoted_wg_ids,
    read_wg_catalog_file, refresh_catalog_file_cache, run_hermit_case, run_wg_case,
    scan_all_passing_axiom_cases, scan_all_passing_wg_cases, scan_all_wg_failures,
    ...
    sync_promoted_lists, user_case_supported, user_wg_case_supported, wg_case_short_id,
    write_promoted_axiom_ids, write_promoted_wg_ids,
};
